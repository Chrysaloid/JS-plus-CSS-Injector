...
var frycAPI = { // eslint-disable-line object-shorthand, no-var
	...
	mimeTypes: null,
	line: null,
	specialStringAHK: "QW1vbmcgdXMgaXMgdmVyeSBTVVM=",
	timeNamesDict: {
		pol: [
			" temu",
			[
				["sekund", "minut", "godzin", "dni", "miesięcy", "lat"],
				["sek"   , "min"  , "godz"  , "dni", "mies"    , "lat"], // eslint-disable-line comma-spacing
				["s"     , "m"    , "g"     , "d"  , "M"       , "l"  ], // eslint-disable-line comma-spacing
			],
		],
		ang: [
			" ago",
			[
				...
				["sec"    , "min"    , "hour" , "days", "mon"   , "year" ], // eslint-disable-line comma-spacing
				["s"      , "m"      , "h"    , "d"   , "M"     , "y"    ], // eslint-disable-line comma-spacing
			],
		],
	},
	// #region //* Zmienne 2
	...
	enforceTitle(title = "Page") {
		return (frycAPI.enforceTitle.mutObs = frycAPI.createMutObs((mutRecArr, mutObs) => {
			if (document.title !== "Messenger") {
				document.title = "Messenger";
			}
		}, { elem: document.querySelector("title"), options: { characterData: true } }));
	}, // frycAPI.enforceTitle("Page");
	allEnglishWordLikeStringsInOneSentence(word = "zoink") {
		word = word.toLowerCase();
		return `${word.frycAPI_toTitleCase()}ity of the ${word}en ${word}s the ${word}est ${word}er with a ${word}able ${word}ment`;
	}, // frycAPI.allEnglishWordLikeStringsInOneSentence("zoink");
	template() {
	}, // frycAPI.template();
	// #region //* Funkcje 5
	// #endregion
...
if (1 && frycAPI_host("192.168.0.1", "192.168.1.1")) {
	frycAPI.line = /*<line-number>*/2136/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		#menu a.sel span.text {
			color: #000000;
		}
	`);
	function getTableOfDevices() {
		const table = [];
		frycAPI.forEach(`tr[id^="connected-clients-grid"]`, (daElem, daI, daArr) => {
			table.push([
				daElem.frycAPI_elemByClass("name").innerText.trim(),
				daElem.frycAPI_elemByClass("ip").innerText.trim(),
				daElem.frycAPI_elemByClass("mac").innerText.trim(),
			]);
		});
		return table;
	}
	frycAPI.createManualFunctions("Router utils", {
		funcArr: [
			(name = "Print device list as table: sort by name", type = frycAPI_Normal) => {
				const f = new type({ name });
				f.callback = function (obj) {
					console.table(getTableOfDevices().sort((a, b) => (a[0] > b[0] ? 1 : -1)));
				};
				return f;
			},
			(name = "Print device list as table: sort by IP", type = frycAPI_Normal) => {
				const f = new type({ name });
				f.callback = function (obj) {
					console.table(getTableOfDevices().sort((a, b) => (a[1] > b[1] ? 1 : -1)));
				};
				return f;
			},
		],
	...
	frycAPI.line = /*<line-number>*/2172/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		button.mojButt {
			position: fixed;
			top: 65px;
	...
	frycAPI.line = /*<line-number>*/2184/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			tab-size: 3 !important;
		}
	...
	frycAPI.line = /*<line-number>*/2952/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
	...
	frycAPI.line = /*<line-number>*/2961/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.cli-barmodal-open {
			overflow: scroll;
		}
	...
	frycAPI.line = /*<line-number>*/2968/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
			filter: invert(1);
		}
	...
	frycAPI.line = /*<line-number>*/2992/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/3751/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			tab-size: 3 !important;
		}
	...
	frycAPI.line = /*<line-number>*/3797/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			tab-size: 3 !important;
		}
	...
	frycAPI.line = /*<line-number>*/4114/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		h2, .h2 {
			color: #F8A238;
		}
	...
	frycAPI.line = /*<line-number>*/4121/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4128/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
			margin: auto;
			display: flex;
	...
	frycAPI.line = /*<line-number>*/4218/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
...
// #region //* IFy  2
	...
	frycAPI.line = /*<line-number>*/4262/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4417/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4452/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/4496/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4505/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4521/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		/*
	...
	frycAPI.line = /*<line-number>*/4582/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		#sidebar {
	...
	frycAPI.line = /*<line-number>*/4628/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		/*
	...
	frycAPI.line = /*<line-number>*/4643/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
	...
	frycAPI.line = /*<line-number>*/4651/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4659/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: none !important;
		}
	...
	frycAPI.line = /*<line-number>*/4666/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: invert(1) !important;
		}
	...
	frycAPI.line = /*<line-number>*/4673/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4853/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
	...
	frycAPI.line = /*<line-number>*/4860/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.gameItem {
			filter: invert(1) hue-rotate(180deg);
		}
	...
	frycAPI.line = /*<line-number>*/4867/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: none !important;
		}
	...
	frycAPI.line = /*<line-number>*/4874/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
			font-family: "IBM Plex Sans Condensed", sans-serif !important;
		}
	...
	frycAPI.line = /*<line-number>*/4881/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		table * {
			font-family: "Source Code Fryc";
		}
...
// #region //* IFy  3
	...
	frycAPI.line = /*<line-number>*/4891/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		td.obj.order.index {
			display: none;
		}
	...
	frycAPI.line = /*<line-number>*/4898/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.statsContainer {
	...
	frycAPI.line = /*<line-number>*/4908/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4915/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: "IBM Plex Sans Condensed", sans-serif !important;
		}
	...
	frycAPI.line = /*<line-number>*/4932/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4939/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4946/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/4953/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	*/
	...
	frycAPI.line = /*<line-number>*/5021/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img.teximage {
	...
	frycAPI.line = /*<line-number>*/5030/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			-webkit-filter: none !important;
			filter: none !important;
	...
	frycAPI.line = /*<line-number>*/5038/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/5045/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			-webkit-filter: none !important;
			filter: none !important;
	...
	frycAPI.line = /*<line-number>*/5053/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/5063/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		#cont {
			position: absolute;
			z-index: 9999;
	...
	frycAPI.line = /*<line-number>*/5087/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		#ucss-code-wrapper .CodeMirror-wrap .CodeMirror-scroll {
			filter: invert(0) hue-rotate(0deg);
			background-color: white;
	...
	frycAPI.line = /*<line-number>*/5113/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: invert(1) hue-rotate(180deg);
		}
	...
	frycAPI.line = /*<line-number>*/5123/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
			background: none;
			background-color: white;
	...
	frycAPI.line = /*<line-number>*/5131/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/5234/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			-webkit-filter: none !important;
			filter: none !important;
...
// #region //* IFy  4
	...
	frycAPI.line = /*<line-number>*/5245/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/5325/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/5332/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
	...
	frycAPI.line = /*<line-number>*/5368/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: invert(1);
	...
	frycAPI.line = /*<line-number>*/5376/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img[src*=".gif"],
		img[src*=".png"]{
			filter: invert(1) hue-rotate(180deg);
	...
	frycAPI.line = /*<line-number>*/5384/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/5397/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		/* Tymczasowe */
	...
	frycAPI.line = /*<line-number>*/5407/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/5420/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: none !important;
		}
	...
	frycAPI.line = /*<line-number>*/5427/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/5469/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			tab-size: 3 !important;
		}
	...
	frycAPI.onLoadSetter(() => {
		...
		frycAPI.createMutObs((mutRecArr, mutObs) => {
			...
			// #endregion
			// #region //* Remove unnecessary "-" before names in comments
			frycAPI.forEach(`a.comment-user`, daElem => {
	...
	frycAPI.line = /*<line-number>*/5906/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/6076/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			filter: invert(1) hue-rotate(180deg);
		}
	...
	frycAPI.line = /*<line-number>*/6091/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: invert(1) hue-rotate(180deg) !important;
		}
	...
	frycAPI.line = /*<line-number>*/6116/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
	...
	frycAPI.line = /*<line-number>*/6123/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			-webkit-filter: none !important;
			filter: none !important;
	...
	frycAPI.line = /*<line-number>*/6131/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
...
// #region //* IFy  5
	...
	frycAPI.line = /*<line-number>*/6141/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.myButn {
			position: absolute;
			top: 20px;
	...
	frycAPI.line = /*<line-number>*/6184/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/6195/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.mojaklasa {
			display: none;
		}
	...
	frycAPI.line = /*<line-number>*/6214/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		nav.list-group.mt-1 {
			margin-bottom: 27px;
		}
	...
	frycAPI.line = /*<line-number>*/6249/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/6957/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: none !important;
		}
	...
	frycAPI.line = /*<line-number>*/6964/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		/*
	...
	frycAPI.line = /*<line-number>*/6991/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
			filter: brightness(1);
		}
	...
	frycAPI.line = /*<line-number>*/6998/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		/* svg image {
			-webkit-filter: none !important;
			filter: none !important;
	...
	frycAPI.line = /*<line-number>*/7038/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: "IBM Plex Sans Condensed", sans-serif !important;
		}
	...
	frycAPI.line = /*<line-number>*/7045/*</line-number>*/; // eslint-disable-line spaced-comment
	const daUrl = new URL(window.location.href);
	...
	frycAPI.line = /*<line-number>*/7454/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/7476/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
	...
	frycAPI.line = /*<line-number>*/7483/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/7494/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
		filter: invert(1) hue-rotate(180deg);
			color: hsl(0deg 0% 58%);
	...
	frycAPI.line = /*<line-number>*/7556/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		/* ::-webkit-scrollbar-thumb {
			background: #70ffde ;
		}
...
// #region //* IFy  6
	...
	frycAPI.line = /*<line-number>*/7582/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: invert(0) hue-rotate(0deg) !important;
		}
	...
	frycAPI.line = /*<line-number>*/7589/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		/*
	...
	frycAPI.line = /*<line-number>*/7608/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/7623/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/7630/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.checkBoxPanel > * {
	...
	frycAPI.line = /*<line-number>*/7655/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.hm60ue {
			margin-top: 50px;
		}
	...
	frycAPI.line = /*<line-number>*/7855/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/7862/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		/* .W9geT {
			filter: invert(1);
		} */
	...
	frycAPI.line = /*<line-number>*/7877/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: invert(0) hue-rotate(180deg) !important;
		}
	...
	frycAPI.line = /*<line-number>*/7884/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.cli-barmodal-open {
			overflow: scroll;
		}
	...
	frycAPI.line = /*<line-number>*/7891/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		#ri-widget {
			display: none !important;
		}
	...
	frycAPI.line = /*<line-number>*/7916/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: IBM Plex Sans Condensed
		}
	...
	frycAPI.line = /*<line-number>*/7937/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body::-webkit-scrollbar {
			width: 15px;
			background: grey;
	...
	frycAPI.line = /*<line-number>*/7950/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: none !important;
		}
	...
	frycAPI.line = /*<line-number>*/7957/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/8052/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		#cont {
			position: absolute;
			z-index: 9999;
	...
	frycAPI.line = /*<line-number>*/8080/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			-webkit-filter: none !important;
			filter: none !important;
...
// #region //* IFy  7
	...
	frycAPI.line = /*<line-number>*/8091/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/8436/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
			font-family: "IBM Plex Sans Condensed", sans-serif;
		}
	...
	frycAPI.line = /*<line-number>*/8561/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
	...
	frycAPI.line = /*<line-number>*/8568/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/8575/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: none !important;
		}
	...
	frycAPI.line = /*<line-number>*/8582/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/8589/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		/*
		img {
			filter: invert(1) hue-rotate(180deg) !important;
	...
	frycAPI.line = /*<line-number>*/8604/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/8619/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: invert(0) hue-rotate(180deg) !important;
		}
	...
	frycAPI.line = /*<line-number>*/8626/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/8798/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/8808/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.mojaklasa {
			display: none;
		}
	...
	frycAPI.line = /*<line-number>*/8827/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: IBM Plex Sans Condensed !important;
		}
	...
	frycAPI.line = /*<line-number>*/8834/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
	...
	frycAPI.line = /*<line-number>*/8863/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		div#ups-alerts {
			color: black;
		}
	...
	frycAPI.line = /*<line-number>*/8870/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			tab-size: 3 !important;
		}
	...
	frycAPI.line = /*<line-number>*/8888/*</line-number>*/; // eslint-disable-line spaced-comment
...
// #region //* IFy  8
	...
	frycAPI.line = /*<line-number>*/8910/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/8925/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		/*
	...
	frycAPI.line = /*<line-number>*/9223/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.line-chart::after {
	...
	frycAPI.line = /*<line-number>*/9243/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img {
			filter: invert(1);
		}
	...
	frycAPI.line = /*<line-number>*/9250/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/9279/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.nazwaBlokuIf = "";
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/9287/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/9294/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.nazwaBlokuIf = "";
	frycAPI.injectStyleOnLoad(/*css*/`
	`);
	...
	frycAPI.line = /*<line-number>*/9303/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.nazwaBlokuIf = "";
	frycAPI.injectStyleOnLoad(/*css*/`
		/*
		.pdf {
	...
	frycAPI.line = /*<line-number>*/9316/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
			margin: auto;
			font-family: IBM Plex Sans Condensed;
	...
	frycAPI.line = /*<line-number>*/9324/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.head a[href="/"] {
	...
	frycAPI.line = /*<line-number>*/9403/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.onLoadSetter(() => {
	...
	frycAPI.line = /*<line-number>*/9516/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		#LeftBar {
			width: 170px;
			&, & > div {
	...
	frycAPI.line = /*<line-number>*/9585/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
	...
	frycAPI.line = /*<line-number>*/9636/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyle(/*css*/`
		div#preloader {
			display: none;
		}
	...
	frycAPI.line = /*<line-number>*/9653/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/9673/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		:root {
			filter: invert(1) hue-rotate(180deg);
		}
	...
	frycAPI.line = /*<line-number>*/9680/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		img[alt="logo"] {
			filter: invert(1) hue-rotate(180deg);
		}
...
// #region //* IFy  9
	...
	frycAPI.line = /*<line-number>*/9690/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.spring-middle>img {
			filter: invert(1) hue-rotate(180deg) !important;
		}
	...
	frycAPI.line = /*<line-number>*/9697/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/9755/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		*:not(i) {
			font-family: "IBM Plex Sans Condensed" !important;
		}
	...
	frycAPI.line = /*<line-number>*/10293/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.onLoadSetter(function () {
		frycAPI.changeFaviconRes("e621_Logo.png");
	});
} else if (frycAPI_host("e-hentai.org")) {
	frycAPI.line = /*<line-number>*/10298/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/10350/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		body {
			max-width: 1000px;
			margin: auto;
	...
	frycAPI.line = /*<line-number>*/10374/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.is-textbox-in-app {
	...
	frycAPI.line = /*<line-number>*/10381/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			tab-size: 3 !important;
		}
	...
	frycAPI.line = /*<line-number>*/10500/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/10507/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: IBM Plex Sans Condensed;
		}
	...
	frycAPI.line = /*<line-number>*/10528/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/10535/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			tab-size: 3 !important;
		}
	...
	frycAPI.onLoadSetter(() => {
		if (frycAPI_host("gist.github.com")) {
	...
	frycAPI.line = /*<line-number>*/10655/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	`);
	...
	frycAPI.line = /*<line-number>*/10668/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/10676/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/10703/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/10712/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		span.DateTime {
			font-weight: bold;
		}
	...
	frycAPI.line = /*<line-number>*/10883/*</line-number>*/; // eslint-disable-line spaced-comment
...
// #region //* IFy 10
	...
	frycAPI.line = /*<line-number>*/10953/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	`);
	...
	frycAPI.line = /*<line-number>*/10990/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/10997/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			tab-size: 3 !important;
		}
	...
	frycAPI.line = /*<line-number>*/11008/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		:root {
	...
	frycAPI.line = /*<line-number>*/11287/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/11295/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		${frycAPI.simpleFontChange}
	`);
} else if (frycAPI_host("web.dev", "developers.google.com", "developer.chrome.com")) {
	frycAPI.line = /*<line-number>*/11300/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.injectStyleOnLoad(/*css*/`
		...
		*:not(
		...
		h2, devsite-toc > ul > li > a {
			font-weight: bold;
			text-transform: uppercase;
		}
		h2:has(+ div > :first-child .dcc-tag-pill) {
			margin-bottom: 0;
		}
		h2:has(+ .dcc-reference .dcc-tag-pill), h2 + .dcc-reference:has(.dcc-tag-pill) {
			width: fit-content;
			display: inline-block;
		}
		h3 {
		...
		h3::before {
			...
			overflow: visible;
			color: var(--devsite-upper-tab-marker-color);
		}
		:has(+ div .dcc-tag-pill--red) > h3::before {
			color: var(--color-red-darkest);
		}
		h4, h5, h6 {
			margin-top: 16px;

			button.devsite-heading-link {
				display: none;
			}
		}
		...
		li.stack {
			...
			& > :first-child {
				...
				.dcc-type--xsmall:not(:first-child) {
					margin-left: 10px;
					padding-left: 10px;
		...
		.dcc-code-sections li>:first-child {
			min-width: 0;
		}
		.dcc-tag-pill--blue {
			background-color: rgb(199 207 221 / 40%);
		}
		.dcc-code-sections__icon::before {
			filter: contrast(0.8);
		}
		:has(> .notranslate):not(:has(devsite-code)) { /* :has(.dcc-tag-pill) */
			display: flex;
			align-items: baseline;
			flex-wrap: wrap;
		...
		:has(> .notranslate):has(.dcc-tag-pill):has(devsite-code) {
			& > .notranslate, & > :has(.dcc-tag-pill) {
				width: fit-content;
				display: inline-block;
			}
		}
		:has(+ .dcc-code-sections > h4[data-text="Enum"]) {
			h3 {
				width: fit-content;
		...
		:has(+ .dcc-code-sections > h4[data-text="Enum"]):has(p + p) {
			p {
		...
		:has(p + p) + .dcc-code-sections:has(> h4[data-text="Enum"]) {
			display: none
		}
		.dcc-code-sections__overline {
			border-top: 0;
		}
		.dcc-code-sections > h4[data-text="Enum"] {
			display: none
		}
		.dcc-code-sections:has(> h4[data-text="Enum"]) {
			.dcc-code-sections__icon {
				border: 1px solid var(--color-hairline);
				border-radius: 12px;
				padding: 8px 12px;
		...
		[theme="chrome-theme"] .dcc-reference .note:not([class*="attempt"]), [theme="chrome-theme"] .dcc-reference devsite-code, [theme="chrome-theme"] .devsite-article-body > .note:not([class*="attempt"]), [theme="chrome-theme"] .devsite-article-body > devsite-code {
			--devsite-code-margin: 24px var(--devside-code-inline-margin);
			--devsite-notice-margin: 24px var(--devside-code-inline-margin);
		}
		devsite-code pre {
			padding: 16px;
		}
		.dcc-code-sections .dcc-code-sections devsite-code {
			margin-left: unset;
			margin-right: unset;
		}
		devsite-code {
		...
		:is(.dcc-code-sections, :has(+ .dcc-code-sections)) > p:last-child {
			margin-bottom: 0;
		}
	`);
	...
	frycAPI.onLoadSetter(function () {
		...
		frycAPI.createMutObs((mutRec, docObs) => {
			...
			frycAPI.forEach(`p:not(.empty-p)`, daElem => {
				if (daElem.innerText === "") {
	...
	frycAPI.line = /*<line-number>*/11553/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.c-cFaYiI {
	...
	frycAPI.line = /*<line-number>*/11560/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/11567/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/11577/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.nameContainer	{
			*:where(:not(.optional)) {
				margin: 5px 0px;
	...
	frycAPI.line = /*<line-number>*/11626/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		.show-me {
			display: block !important;
		}
	...
	frycAPI.line = /*<line-number>*/11651/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.onLoadSetter(function () {
	...
	frycAPI.line = /*<line-number>*/11658/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: "IBM Plex Sans Condensed", sans-serif;
		}
	...
	frycAPI.line = /*<line-number>*/11694/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: "IBM Plex Sans Condensed", sans-serif;
		}
	...
	frycAPI.line = /*<line-number>*/11763/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: "IBM Plex Sans Condensed", sans-serif;
		}
	...
	frycAPI.line = /*<line-number>*/11770/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		iframe#external {
	...
	frycAPI.line = /*<line-number>*/11777/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	`);
	...
	frycAPI.line = /*<line-number>*/11795/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: "IBM Plex Sans Condensed", sans-serif;
		}
	...
	frycAPI.line = /*<line-number>*/11827/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.colorSchemeDark = true;
} else if (frycAPI_hostIncludes("wiki.gg")) {
	frycAPI.line = /*<line-number>*/11830/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/11897/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: "IBM Plex Sans Condensed", sans-serif !important;
		}
	...
	frycAPI.line = /*<line-number>*/11905/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		*:not(code, code *) {
			font-family: "IBM Plex Sans Condensed", sans-serif !important;
		}
	...
	frycAPI.line = /*<line-number>*/11912/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	...
	frycAPI.line = /*<line-number>*/11926/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	`);
	...
	frycAPI.line = /*<line-number>*/11941/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		* {
			font-family: "IBM Plex Sans Condensed", sans-serif;
		}
	...
	frycAPI.line = /*<line-number>*/11948/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/11989/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
	`);
	...
	frycAPI.line = /*<line-number>*/12003/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.onLoadSetter(function () {
		frycAPI.qSel(`.loginbtn-btn`)?.click();
	}, 2);
} else if (frycAPI_host("keep.google.com")) {
	frycAPI.line = /*<line-number>*/12008/*</line-number>*/; // eslint-disable-line spaced-comment
	...
	frycAPI.line = /*<line-number>*/12075/*</line-number>*/; // eslint-disable-line spaced-comment
	window.alert = function (message) {
		console.log(message);
	};
} else if (frycAPI_host("iformatki.pl")) {
	frycAPI.line = /*<line-number>*/12080/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		#visualization_1 {
			position: sticky;
			top: 78px;
	...
	frycAPI.line = /*<line-number>*/12088/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		#container {
			background: black;
			color: white;
	...
	frycAPI.line = /*<line-number>*/12102/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		::selection {
			background: #1640A0;
		}
	...
	frycAPI.line = /*<line-number>*/12109/*</line-number>*/; // eslint-disable-line spaced-comment
	frycAPI.injectStyleOnLoad(/*css*/`
		ad-placeholder {
			display: none !important;
		}
